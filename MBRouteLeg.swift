...
open class RouteLeg: NSObject, NSSecureCoding {
    ...
    public override init() {
        ...
        self.source = Waypoint.init(coordinate: CLLocationCoordinate2DMake(0.0, 0.0))
        self.destination = Waypoint.init(coordinate: CLLocationCoordinate2DMake(0.0, 0.0))
        self.steps = [RouteStep]()
        self.openStreetMapNodeIdentifiers =  [Int64]()
        self.segmentDistances = [CLLocationDistance]()
        self.expectedSegmentTravelTimes = [TimeInterval]()
        self.segmentSpeeds = [CLLocationSpeed]()
        self.segmentCongestionLevels = [CongestionLevel] ()
        self.name = ""
       self.distance = CLLocationDistance()
        self.expectedSegmentTravelTimes = [TimeInterval]()
        self.expectedTravelTime = TimeInterval()
        self.profileIdentifier = MBDirectionsProfileIdentifier.init("")
    }

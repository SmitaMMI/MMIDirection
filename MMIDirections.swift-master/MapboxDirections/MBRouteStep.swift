...
open class RouteStep: NSObject, NSSecureCoding {
    ...
    public override init() {
        ...
        self.finalHeading = 0.00
        self.maneuverType = ManeuverType(rawValue: Int(0.0))
        self.maneuverDirection = ManeuverDirection(rawValue: Int(0.0))
        self.maneuverLocation = CLLocationCoordinate2DMake(0.0, 0.0)
        self.exitIndex = 0
        self.exitCodes = [String]()
        self.exitNames = [String]()
        self.distance = 0.0
        self.expectedTravelTime = 0.0
        self.codes = [String]()
        self.transportType = TransportType(rawValue: Int(0.0))
        self.destinationCodes = [String]()

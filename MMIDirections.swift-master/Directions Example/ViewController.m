...
NSString * const MapboxAccessToken = @"pk.eyJ1Ijoic3VzaHJlZSIsImEiOiJjajZldTl5eHcyNnk1MzJscWZiODZvMTN1In0.5hBcTeC25l66pM9eryHnCA";
...
//    NSAssert(![MapboxAccessToken isEqualToString:@"pk.eyJ1Ijoic3VzaHJlZSIsImEiOiJjajZldTl5eHcyNnk1MzJscWZiODZvMTN1In0.5hBcTeC25l66pM9eryHnCA"], @"You must set `MapboxAccessToken` to your Mapbox access token.");
